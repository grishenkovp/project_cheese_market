...
CUSTOMER_COUNT = sum(CUSTOMER_PROPORTION.values())
...
CUSTOMER_LIST_SIGNIFICANT_PRICE_CHANGE = [5,7.5,10,15,20]

# Список выбора объема покупки
BUY_LIST_VALUE_CHEESE = [100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000]
...
RETAILER_TOP_LIST = "'A1','A2','A3','A4','A5'"
...
#-----------------------------------------------------------------------------------------------------------------------
# Номер рабочей модели.
# Активным может быть только один пункт!
# Его номер соответствует номеру из датасета с загружаемыми ценами!
# MODEL_WORK = 0
# MODEL_WORK = 1
MODEL_WORK = 2